...
# Test accounts
sb_seed = 'sEdTRGt3eQ9kawZXBxYAPUssuW1MBoU'
sb_account = 'rJmadnk4pGAvMt9AdU18ppebZDgBLzrhdy'

op_seed = 'sEdS4LT6YnZbchXjR8iAmBVJ1QNyNvD'
op_account = 'rJNiCBGB83JWSsTgdTo4AZqyuwjPPnhaZi'
...
def get_standby_account_info():
    ...
    accountInfo = get_account_info(sb_account)
...
def standby_send_xrp():
    ...
    response = send_xrp(sb_seed,ent_standby_amount.get(), ent_standby_destination.get())
    text_standby_results.delete("1.0", tk.END)
...
def get_operational_account_info():
    ...
    accountInfo = get_account_info(op_account)
...
def operational_send_xrp():
    ...
    response = send_xrp(op_seed,op_account, ent_operational_destination.get())
    text_operational_results.delete("1.0", tk.END)
...
ent_standby_seed.insert(0, sb_seed)  
lbl_standby_account = tk.Label(master=frm_form, text="Standby Account")
ent_standby_account = tk.Entry(master=frm_form, width=50)
ent_standby_account.insert(0, sb_account)  
lbl_standy_amount = tk.Label(master=frm_form, text="Amount")
ent_standby_amount = tk.Entry(master=frm_form, width=50)
ent_standby_amount.insert(0, 100)  # default to 100
lbl_standby_destination = tk.Label(master=frm_form, text="Destination")
ent_standby_destination = tk.Entry(master=frm_form, width=50)
ent_standby_destination.insert(0, op_account)  # send to operation account
...
ent_operational_seed.insert(0, op_seed) 
lbl_operational_account = tk.Label(master=frm_form, text="Operational Account")
ent_operational_account = tk.Entry(master=frm_form, width=50)
ent_operational_account.insert(0, op_account) 
